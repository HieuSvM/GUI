...
def ex():
    sys.exit()
Button(root, text ="Open File",width=20,height=3, command = openfile).place(x=240,y=600)
Button(root, text ="Exit",width=20,height=3, command = ex).place(x=450,y=600)
